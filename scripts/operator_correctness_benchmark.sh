...
"$ROOT_DIR/scripts/local_xla_exec.sh" "$CORRECTNESS_ENTRY" | tee "$OUT_DIR/correctness.log"
"$ROOT_DIR/scripts/local_xla_exec.sh" "$BENCH_ENTRY" | tee "$OUT_DIR/benchmark.log"
